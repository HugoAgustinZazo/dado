...
import com.example.miprimerproyecto.databinding.ActivityFbConAutGBinding
...
class FbConAutG : AppCompatActivity() {
    lateinit var binding: ActivityFbConAutGBinding
    private lateinit var auth: FirebaseAuth
    private lateinit var googleSignInClient: GoogleSignInClient
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityFbConAutGBinding.inflate(layoutInflater)
        enableEdgeToEdge()
        setContentView(R.layout.activity_fb_con_aut_g)
